<?php
$bakPic = "Fms.jpg";
$reason = "Either the username or the password is not right. Please try again.";
?>
        ...
        <div class="row">
            ...
            <div class="login-form pl-3">
               ...
               <form action="check.php" method="post">
                  ...
                  <button type="submit" class="btn btn-black text-white">Login</button>
                  <div>
                   <a class="text-primary pl-2" href="/register.php">New User?Create Account</a>
                  </div>
               </form>
            </div>
            </div>
